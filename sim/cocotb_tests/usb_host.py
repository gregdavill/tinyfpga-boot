...
# Speed-independent packet primitives are shared with the HS host. Re-exported
# below so existing `from .usb_host import PID, crc16, ...` imports keep working.
from .usb_packets import (  # noqa: F401
    PID, crc5, crc16, build_token, build_sof, build_data, build_handshake,
    EndpointToggle,
)
...
# ----------------------------------------------------------------------
# NRZI + bit-stuffing (FS gateware-PHY wire encoding only)
# ----------------------------------------------------------------------
